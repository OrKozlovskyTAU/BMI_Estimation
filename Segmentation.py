...
url = "./Org_data/org_0_F_15_162560_6123497.jpg"
...
for label, color in color_map.items():
    ...
    label_id = list(color_map.keys()).index(label)
    # Create a mask for the current class label
    mask = (predicted_panoptic_map == label_id)
    ...
    if label == '1' or label == '2' or label == '3' or label == '4' or label == '5' or label == '6' or label == '7' or label == '8' or label == '9' or label == '10' or label == '11' or label == '12' or label == '13' or label == '14' or label == '15':
...
overlayed_image.save("overlayed_image_with_mask_____coco.png")

# Save the modified image with removed parts to a file
modified_image.save("modified_image_removed_parts__________coco.png")
